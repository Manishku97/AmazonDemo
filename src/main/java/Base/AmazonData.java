...
public class AmazonData {
	...
	// Method to get Data from Excel by column name
...
//	    int rowIndex = 1;
//	    return getInputDataFromExcel(filePath, sheetName, rowIndex, key);
//	}
//
//	// Method to get data from Excel by column name and row index
//	public static String getInputDataFromExcel(String filePath, String sheetName, int rowIndex, String columnName) {
...
//	        	System.out.println(headerRow.getCell(cellIndex).getStringCellValue());
...
//	        if (dataRow == null) {
//	            throw new IllegalArgumentException("Data row not found at index: " + rowIndex);
//	        }
//
